...
import womenDetail from "./components/products/womenDetail/WomensPage";
// import WomensPage from "./components/products/productDetail/WomensPage";
...
function App() {
  ...
  return (
    <Router>
      ...
      <Route path="/women/:code" component={womenDetail} />
